let data = [
   ...
   */
  {
    ...
    callback: { name: '518d7b08-f825-486d-be88-1a4df2653022', type: 'document' },
    insertionPoint: [
  ...
  {
    label: { name: 'URL: /google276dc830e9fade0c.html' },
    key: 'ff727650-6dfb-48bf-bfc7-be4ad6a6bcdd',
    unitKey: '9c6dd381-0f9b-4d6d-9a96-bf9beb3d3108',
    callback: { name: '7acf5873-630c-41a7-84c4-4b0d52706981', type: 'middlewareNestedUnit' },
  },
  ...
  },
  {
    ...
    insertionPoint: [{ key: '2299cc1e-238f-4fe5-9069-51351ded59a7', order: 1, executionType: 'raceFirstPromise' }],
    children: [
